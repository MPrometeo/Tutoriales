...
\begin{proof}
Supongamos que $A \subseteq B$. Debemos demostrar que $A \cup B = B$. PUTODFAFSAFASFSAFDSAFSAFASFSADFDAS chingas a tu putAmsreeweDAJSHFJdsaiofjaudsfasjfipasfjaisfjadsifjasifjasifjasdfijasfjadsifjafpaifjasfjasdfjdsafdfasjidfjidjidasjfiafdsfdjiadjifs
...
\end{enumerate}
(Aquí va el resto de tu desarrollo matemático usando AQUI TE VAS A LA VERGAAAAAA $x \in A \implies x \in B$).
\end{proof}
